...
This script trains a T5 model for translating crystal structure
representations (HSSR) to natural language descriptions.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Train S2T model")
...
def main():
    ...
    # Log configuration
    logger.info("=" * 50)
    logger.info("CrystalLM S2T Training")
    logger.info("=" * 50)
    ...
    data_module = CrystalLMDataModule(
        ...
        test_file=args.val_file,  # Use val as test for now
        tokenizer=tokenizer,
